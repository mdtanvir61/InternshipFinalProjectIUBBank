  ...
  return (
    <section className="relative w-full bg-[#f5faff] min-h-[380px] md:min-h-[440px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute right-8 top-1/2 transform -translate-y-1/2 z-10 hidden lg:block">
        <img
          src="https://cdni.iconscout.com/illustration/premium/thumb/welcome-board-illustration-download-in-svg-png-gif-file-formats--welcoming-man-greeting-pack-miscellaneous-illustrations-3231454.png"
          alt="Login Banner"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center justify-center px-6 md:px-12 py-12">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-5xl md:text-6xl font-extrabold text-[#181f2a] mb-4 text-center">Dashboard</h1>
          ...
          <button
            ...
            className="mt-8 px-8 py-3 bg-blue-700 text-white rounded-full font-semibold shadow hover:bg-blue-800 transition"
